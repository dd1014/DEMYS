								...
								<div class="row" style="display: flex;">
										...
										<div style="margin: 10px;">
												...
												<div class="flex" style="margin-left: 20px;margin-top:10px; margin-bottom:10px;">
														<!-- 아이디 -->
														<div class="col-sm-6 grid-rows-5"
																style="font-size: 15px; text-align: left; line-height: 35px; font-weight: bold; height: 35px; width: 400px;">
																아이디</div>
														&nbsp;&nbsp;&nbsp;
														<!-- 아이디 정보칸 -->
														<input type="text" class=" input input-bordered w-full max-w-xs"
																style="height: 35px;pointer-events: none; width: 100%; background-color: #E7E7E7; " />
