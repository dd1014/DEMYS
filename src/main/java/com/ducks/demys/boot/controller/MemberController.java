...
=======
	...
	@ResponseBody
	public String doJoin(String MEMBER_ID, String MEMBER_PW, String MEMBER_NAME, String MEMBER_PHONE,
			String MEMBER_EMAIL, String MEMBER_DEP, int MEMBER_AUTHORITY, int MEMBER_STATUS, String MEMBER_PIC) {
		memberService.doJoin(MEMBER_ID, MEMBER_PW, MEMBER_NAME, MEMBER_PHONE, MEMBER_EMAIL, MEMBER_DEP,
				MEMBER_AUTHORITY, MEMBER_STATUS, MEMBER_PIC);
